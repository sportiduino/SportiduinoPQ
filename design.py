...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SelectPrinter.setGeometry(QtCore.QRect(10, 160, 111, 31))
        self.SelectPrinter.setObjectName("SelectPrinter")
        self.ReadCard = QtWidgets.QPushButton(self.tab_4)
        self.ReadCard.setGeometry(QtCore.QRect(10, 10, 111, 31))
        self.ReadCard.setObjectName("ReadCard")
        self.OpenGpx = QtWidgets.QPushButton(self.tab_4)
        self.OpenGpx.setGeometry(QtCore.QRect(10, 60, 111, 31))
        self.OpenGpx.setObjectName("OpenGpx")
        self.AutoPrint = QtWidgets.QCheckBox(self.tab_4)
        self.AutoPrint.setGeometry(QtCore.QRect(10, 200, 121, 31))
        self.AutoPrint.setObjectName("AutoPrint")
        self.printerName = QtWidgets.QLabel(self.tab_4)
        self.printerName.setGeometry(QtCore.QRect(10, 130, 141, 41))
        self.printerName.setText("")
        self.printerName.setObjectName("printerName")
        self.line_8 = QtWidgets.QFrame(self.tab_4)
        self.line_8.setGeometry(QtCore.QRect(0, 40, 211, 20))
        self.line_8.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_8.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_8.setObjectName("line_8")
        self.line_9 = QtWidgets.QFrame(self.tab_4)
        self.line_9.setGeometry(QtCore.QRect(0, 90, 211, 20))
        self.line_9.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_9.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_9.setObjectName("line_9")
        self.line_10 = QtWidgets.QFrame(self.tab_4)
        self.line_10.setGeometry(QtCore.QRect(0, 220, 211, 20))
        self.line_10.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_10.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_10.setObjectName("line_10")
        self.dateTimeEdit = QtWidgets.QDateTimeEdit(self.tab_4)
        self.dateTimeEdit.setGeometry(QtCore.QRect(10, 270, 161, 22))
        self.dateTimeEdit.setObjectName("dateTimeEdit")
        self.ForceStart = QtWidgets.QCheckBox(self.tab_4)
        self.ForceStart.setGeometry(QtCore.QRect(10, 240, 121, 31))
        self.ForceStart.setObjectName("ForceStart")
        self.Log.addTab(self.tab_4, "")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.InitCard = QtWidgets.QPushButton(self.tab)
        self.InitCard.setGeometry(QtCore.QRect(10, 50, 111, 31))
        self.InitCard.setObjectName("InitCard")
        self.cardLine = QtWidgets.QLineEdit(self.tab)
        self.cardLine.setGeometry(QtCore.QRect(10, 10, 111, 31))
        self.cardLine.setObjectName("cardLine")
        self.AutoIncriment = QtWidgets.QCheckBox(self.tab)
        self.AutoIncriment.setGeometry(QtCore.QRect(10, 90, 151, 31))
        ...
        self.SleepCard.setGeometry(QtCore.QRect(10, 290, 91, 31))
        self.SleepCard.setObjectName("SleepCard")
        self.line_2 = QtWidgets.QFrame(self.tab_2)
        self.line_2.setGeometry(QtCore.QRect(-3, 30, 211, 41))
        ...
        MainWindow.setTabOrder(self.CheckInitTime, self.CardCap)
        MainWindow.setTabOrder(self.CardCap, self.AutoDel)
        MainWindow.setTabOrder(self.AutoDel, self.NewPass)
        MainWindow.setTabOrder(self.NewPass, self.OldPass)
        MainWindow.setTabOrder(self.OldPass, self.PassCard)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.OpenGpx.setText(_translate("MainWindow", "Open gpx"))
        self.AutoPrint.setText(_translate("MainWindow", "AutoPrint"))
        self.ForceStart.setText(_translate("MainWindow", "ForceStart"))
