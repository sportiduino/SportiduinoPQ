...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ReadCard.setGeometry(QtCore.QRect(10, 160, 111, 31))
        self.ReadCard.setObjectName("ReadCard")
        self.line = QtWidgets.QFrame(self.tab)
        self.line.setGeometry(QtCore.QRect(0, 130, 211, 20))
        ...
        MainWindow.setTabOrder(self.AutoIncriment, self.ReadCard)
        MainWindow.setTabOrder(self.ReadCard, self.SetTime)
